...
\begin{enumerate}
    ...
    \item \textbf{05/03/2024:}
        \begin{itemize}
            \item Il faut faire pour afficher la liste des beacons dans la fenêtre modale de la page de l'entrepôt
            \item Il faut faire pour enregistrer la valeur de la plaque d'immatriculation localement au téléphone (JSON ou datastore) et faire pour que au démarrage de l'application, si localement on a une plaque on la saisie et sinon on demande de la saisir
        \end{itemize}
\end{enumerate}
