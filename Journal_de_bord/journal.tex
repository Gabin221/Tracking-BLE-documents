...
\begin{enumerate}
    ...
    \item \textbf{09/02/2024:}
        \begin{itemize}
            \item Finalement M. Le Joncour a réussi à me montrer comment utiliser la recherche de beacons grâce à ce lien donc je vais normalement pouvoir garder mon application de base
        \end{itemize}
\end{enumerate}
