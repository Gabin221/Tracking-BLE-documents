...
\begin{enumerate}
    ...
    \item \textbf{01/02/2024:}
        \begin{itemize}
            ...
            \item J'ai mis l'application provenant de \href{https://github.com/Gabin221/android-beacon-library-reference-kotlin}{github} sur mon téléphone afin d'avoir une balise fonctionnelle en permanance
        \end{itemize}
\end{enumerate}
